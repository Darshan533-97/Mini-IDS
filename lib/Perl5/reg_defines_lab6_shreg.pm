...
package reg_defines_lab6_shreg;
...
sub DEVICE_PROJ_DIR ()  { "lab6_shreg"; }
...
sub IDS_IDS_SWREG1_REG ()   { 0x2000300;}
sub IDS_IDS_SWREG2_REG ()   { 0x2000304;}
sub IDS_IDS_CMD_REG ()      { 0x2000308;}
sub IDS_IDS_HWREG1_REG ()   { 0x200030c;}
sub IDS_IDS_HWREG2_REG ()   { 0x2000310;}
