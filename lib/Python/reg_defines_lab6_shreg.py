...
def IDS_IDS_SWREG1_REG (): 
    return 0x2000300

def IDS_IDS_SWREG2_REG (): 
    return 0x2000304

def IDS_IDS_CMD_REG ():    
    return 0x2000308

def IDS_IDS_HWREG1_REG (): 
    return 0x200030c

def IDS_IDS_HWREG2_REG (): 
    return 0x2000310
...
__main__.nf_regmap.update({
    ...
    0x2000300 : "IDS_IDS_SWREG1_REG",
    0x2000304 : "IDS_IDS_SWREG2_REG",
    0x2000308 : "IDS_IDS_CMD_REG",
    0x200030c : "IDS_IDS_HWREG1_REG",
    0x2000310 : "IDS_IDS_HWREG2_REG",
