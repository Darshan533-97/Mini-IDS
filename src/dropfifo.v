...
// /___/   /\     Timestamp : 01/27/2023 18:26:35
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/Archive/EE-533/Lab5_final/Lab5_final/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   AND2B1 XLXI_12 (.I0(XLXN_29), 
                   .I1(XLXN_17), 
                   .O(XLXN_22));
   OR2 XLXI_13 (.I0(XLXN_16), 
                .I1(XLXN_15), 
                .O(XLXN_17));
   VCC XLXI_15 (.P(XLXN_38));
   AND3B2 XLXI_16 (.I0(XLXN_35), 
                   .I1(XLXN_34), 
                   .I2(fiforead), 
                   .O(XLXN_37));
   memory_final XLXI_17 (.addra(waddr[7:0]), 
                         .addrb(raddr[7:0]), 
                         .clka(clk), 
                         .clkb(clk), 
                         .dina(in_fifo0[71:0]), 
